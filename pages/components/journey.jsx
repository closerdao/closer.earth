...
const jour = {
  year: "2023",
  pic: BluTick,
  text: "2 active villages",
  text2: "5 under development",
  line: Line,
  ...
  years: "2024",
  pics: BluTick,
  texts: "10 active village",
  texts2: "10 developments",
  lines: Line,
  ...
  yearss: "2025",
  picss: BluTick,
  textss: "20 active village",
  textss2: "20 under development",
  liness: Line,
  ...
  return (
    <>
      <div id="journey" className="bg-[#171717] py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10 w-[90%] xl:w-[80%] 2xl:w-[40%] mx-auto">
          <div
            style={{
